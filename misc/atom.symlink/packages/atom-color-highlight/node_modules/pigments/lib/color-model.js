(function() {
  var Color, ColorConversions, ColorParsing, ColorVariablesParsing, NamedColors, PropertyAccessors, _;
  ...
  module.exports = Color = (function() {
    ...
    function Color(colorExpression, fileVariables) {
      var _ref;
      this.colorExpression = colorExpression != null ? colorExpression : null;
      ...
      if (this.colorExpression != null) {
        this.parseExpression(this.colorExpression, fileVariables);
      }
    }

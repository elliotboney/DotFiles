(function() {
  ...
  module.exports = NamedColors = (function() {
    function NamedColors() {}

    NamedColors.extend = function(Color) {
      var a, colors, k, v, _results;
      Color.namedColors = {};
      colors = {
        alice_blue: '#f0f8ff',
      ...
      for (k in colors) {
        v = colors[k];
        a = k.split('_');
        _results.push(Color.namedColors[a.map(function(s) {
          return s[0].toUpperCase() + s.slice(1);
        }).join('')] = Color.namedColors[a.join('').toUpperCase()] = Color.namedColors[a.join('')] = v);
      }
      return _results;
    };

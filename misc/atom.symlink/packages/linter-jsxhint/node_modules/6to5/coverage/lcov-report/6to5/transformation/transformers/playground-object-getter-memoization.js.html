...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformation/transformers/playground-object-getter-memoization.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformation/transformers/playground-object-getter-memoization.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformation/transformers/</a> &#187; playground-object-getter-memoization.js</div>
</div>
<div class="body">
...
&nbsp;
  traverse(value, {
    enter: function (node) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (t.isFunction(node)) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;

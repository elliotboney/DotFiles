...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformation/transformers/spec-no-duplicate-properties.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformation/transformers/spec-no-duplicate-properties.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformation/transformers/</a> &#187; spec-no-duplicate-properties.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    if (t.isIdentifier(key)) {
      key = key.name;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (t.isLiteral(key)) {
      key = key.value;
    } else {

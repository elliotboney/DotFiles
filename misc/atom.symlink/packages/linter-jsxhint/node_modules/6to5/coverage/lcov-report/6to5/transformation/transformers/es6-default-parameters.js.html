...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (has &amp;&amp; node.params.indexOf(has) &lt; 0) {
<span class="cstat-no" title="statement not covered" >      iife = true;</span>
    }
  }
&nbsp;
  var body = [];

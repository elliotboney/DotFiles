...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">84.72% <small>(61 / 72)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(11 / 11)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">95.1% <small>(136 / 143)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
          if (i2 &gt;= i) break;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (t.isSpreadProperty(prop2)) <span class="cstat-no" title="statement not covered" >continue;</span>
&nbsp;
          var key = prop2.key;
...
var pushArrayPattern = function (opts, nodes, pattern, parentId) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!pattern.elements) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
  var i;
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (i in nodes) {</span>

...
&nbsp;
transform.fromAst = <span class="fstat-no" title="function not covered" >function (ast, code, opts) {</span>
<span class="cstat-no" title="statement not covered" >  ast = util.normaliseAst(ast);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var file = new File(opts);</span>
<span class="cstat-no" title="statement not covered" >  file.addCode(code);</span>
<span class="cstat-no" title="statement not covered" >  file.transform(ast);</span>
<span class="cstat-no" title="statement not covered" >  return file.generate();</span>
};
&nbsp;

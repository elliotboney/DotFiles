...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">99.22% <small>(127 / 128)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">96% <small>(48 / 50)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(16 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">100% <small>(123 / 123)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  if (!ModuleFormatter) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (loc) <span class="cstat-no" title="statement not covered" >ModuleFormatter = require(loc);</span>
  }
&nbsp;
  if (!ModuleFormatter) {

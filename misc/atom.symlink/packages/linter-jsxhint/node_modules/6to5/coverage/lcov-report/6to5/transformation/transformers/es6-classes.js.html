...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">98.66% <small>(147 / 149)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">93.42% <small>(71 / 76)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(10 / 10)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">98.6% <small>(141 / 143)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
exports.ClassDeclaration = function (node, parent, file, scope) {
  var closure = true;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (t.isProgram(parent) || <span class="branch-1 cbranch-no" title="branch not covered" >t.isBlockStatement(parent))</span> {
    closure = false;
  }
&nbsp;
  ...
  if (factory.closure) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (closure) {
...
<span class="cstat-no" title="statement not covered" >      return t.assignmentExpression("=", node.id, newNode);</span>
    } else {
...
&nbsp;
  if (superName &amp;&amp; t.isDynamic(superName)) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (className) superRefName = className.name + "Super";
&nbsp;
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (t.isPrivateDeclaration(node)) {
      self.closure = true;
      body.unshift(node);
    }
  }

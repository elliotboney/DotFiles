...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">96.92% <small>(220 / 227)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">91.54% <small>(119 / 130)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(29 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">98.07% <small>(203 / 207)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1713</span>
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (node &amp;&amp; !node.label) {
        if (t.isBreakStatement(node)) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (t.isSwitchCase(parent)) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
          has.hasBreak = true;
...
<span class="cstat-no" title="statement not covered" >        if (isVar(node.init, node)) {</span>
...
<span class="cstat-no" title="statement not covered" >        if (isVar(node.left, node)) {</span>
...
&nbsp;
  for (var i in node.declarations) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!declar.init) <span class="cstat-no" title="statement not covered" >continue;</span>
&nbsp;

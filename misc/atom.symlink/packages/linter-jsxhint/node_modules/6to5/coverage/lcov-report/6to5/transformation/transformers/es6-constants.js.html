...
&nbsp;
  var check = function (parent, names, scope) {
    for (var name in names) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (parent &amp;&amp; t.isBlockStatement(parent) &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >parent !== constants[name])</span> <span class="cstat-no" title="statement not covered" >continue;</span>
&nbsp;
      if (scope) {
...
&nbsp;
  _.each(node.body, function (child, parent) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (t.isExportDeclaration(child)) {
<span class="cstat-no" title="statement not covered" >      child = child.declaration;</span>
    }
&nbsp;

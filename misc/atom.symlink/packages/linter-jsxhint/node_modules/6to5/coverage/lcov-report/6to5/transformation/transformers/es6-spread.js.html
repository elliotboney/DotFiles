...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">97.22% <small>(70 / 72)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-yes">1859</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (t.isDynamic(contextLiteral)) {
<span class="cstat-no" title="statement not covered" >      temp = contextLiteral = scope.generateTemp(file);</span>
<span class="cstat-no" title="statement not covered" >      callee.object = t.assignmentExpression("=", temp, callee.object);</span>
    }
&nbsp;
    if (callee.computed) {
